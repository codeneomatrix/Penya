...
uint256 hashGenesisBlock("0xcc9b6816121dce6179bc4f41e7d3b31f86255a6fcb22aa80b0798cae2ff0dfdf");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Penya: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Penya Signed Message:\n";
...
{
    // Penya: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Penya: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Penya: 3.5 days
static const int64 nTargetSpacing = 150; // Penya: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Penya: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Penya: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Penya: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3f20414ce25ea8131db84de81f0272062d7d5260574141e0dda9c534ae59ce65");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("dd2f496c0a09ea062706886d5a55d1f266605244ef93f00d8f9dee596a2078525b8c38f542ee28ff4243177f82ebb83c1b6974c91fafc81d7ea79070678198a2ba") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1496523462;
        block.nBits    = 504365644;
        block.nNonce   = 1551763252;

        if (fTestNet)
        {
            block.nTime    = 1496523462;
            block.nNonce   = 2537508941;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3a26f1afc4f6722343d13a04d10f7d3d6223a77efe358ea0523af5e1c6d50923"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Penya: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PenyaMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PenyaMiner : ProcessBlock, block not accepted");
    }
